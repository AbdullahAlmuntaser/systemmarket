...
class NameNormalizer {
  ...
  static double calculateSimilarity(String normalized1, String normalized2) {
    ...
    if (normalized1.contains(normalized2) || normalized2.contains(normalized1)) {
      ...
      final longer = normalized1.length < normalized2.length ? normalized2 : normalized1;
  ...
  static bool isMatch(String normalized1, String normalized2, {double threshold = 0.8}) {
    // Exact match
